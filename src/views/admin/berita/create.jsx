...
export default function CreateBerita() {
  ...
  async function onSubmit(data) {
    try {
      ...
      formdata.append("thumbnail", imgData);
      await api_service.postWithDocument("/berita/create", formdata);
      setIsLoading(false);
  ...
  useEffect(() => {
    if (konten.length === 0 || konten === "<p><br></p>" || !imgData) {
      setIsDisable(true);
    } else {
      setIsDisable(false);
    }
  }, [konten, imgData, errors?.judul]);
  return (
    <>
      <div className="mt-3">
